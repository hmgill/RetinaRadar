...
class RetinaRadarDataset(pydantic.BaseModel):
    ...
    def num_labels(self) -> int:
        """
        The total number of distinct label columns after one-hot encoding.
        This is the required output size for the model's final layer.
        """
        encoder = self.onehot_encoder
        if encoder is None:
            return 0
        
        # The total number of labels is the total number of columns in the one-hot encoded array
