...
class IO:
    ...
    def match_images_and_metadata(
        self,
        image_labels_dataframe : Union[str, Path],
        image_paths_dataframe : Union[str, Path]
    ):

        # retrieve image data
        image_data = self.read_df(image_labels_dataframe)

        # get the map of dataset source : image paths
        source_metadata = self.read_df(image_paths_dataframe)
    ...
    def read_dataset(self):
        ...
        matched_info = self.match_images_and_metadata(
            self.config["dataset"]["image_labels_dataframe"],
            self.config["dataset"]["image_paths_dataframe"]            
        )
